...
int illeal = 0;
std::vector<list> seqL; // [[hurrylevel, appearingtime]...]
...
void setupScenario(RVO::RVOSimulator *sim)
{
	...
	// sim->addAgent(RVO::Vector2(9.9f, -3.0f));
	// goals.push_back(RVO::Vector2(-14.1f, -3.0f));
	// sim->addAgent(RVO::Vector2(9.9f, -2.0f));
	// goals.push_back(RVO::Vector2(-14.1f, -2.0f));
	// sim->addAgent(RVO::Vector2(9.9f, -1.0f));
	// goals.push_back(RVO::Vector2(-14.1f, -1.0f));
	// sim->addAgent(RVO::Vector2(9.9f, 0.0f));
	// goals.push_back(RVO::Vector2(-14.1f, 0.0f));
	// sim->addAgent(RVO::Vector2(9.9f, 1.0f));
	// goals.push_back(RVO::Vector2(-14.1f, 1.0f));
	// sim->addAgent(RVO::Vector2(9.9f, 2.0f));
	// goals.push_back(RVO::Vector2(-14.1f, 2.0f));
...
int main()
{
	...
	do {
		...
		sim->doStep();
		// add agents to the array for waiting ones, do the same for left and right
		if sim->getGlobalTime() == seqL[time]
			waitL += seqL // track his hurrylevel and appearing time
